...
namespace YilanOyunu
{
    public partial class Form1 : MetroForm
    {
        ...
        private void YemCiz(Graphics g)
        {
            ...
            g.FillRectangle(Brushes.Gray, x, y, bogumBoyut, bogumBoyut);
        ...
        private void BogumCiz(Graphics g, int sutunNo, int satirNo, bool basMi = false)
        {
            ...
            g.FillRectangle(basMi ? Brushes.Cyan : Brushes.Red, x, y, bogumBoyut, bogumBoyut);
            g.DrawRectangle(Pens.Black, x, y, bogumBoyut - 1, bogumBoyut - 1);
        }
        ...
        {       //metroform bug (odaklanmama) sorunu için
            BringToFront();
        }
        ...
        {
            string skorMetin = string.Format("{0:0000};{1};{2}", puan, DateTime.Now.ToString("s"), oyuncu);
